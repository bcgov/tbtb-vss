...
<!--                            <template #content>-->
<!--                                <BreezeDropdownLink :href="route('reports')">-->
<!--                                    Reports2-->
<!--                                </BreezeDropdownLink>-->
<!--                            </template>-->
<!--                        </BreezeDropdown>-->
...
<!--                <BreezeResponsiveNavLink :href="route('reports')" :active="route().current('reports')">-->
<!--                    Reports-->
<!--                </BreezeResponsiveNavLink>-->
<!--            </div>-->
...
<!--                {{pageRoute.name}}-->
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" :href="route('cases.index')" :active="route().current('cases.*')">
                            Cases
                        </BreezeNavLink>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" :href="route('maintenance')" :active="route().current('maintenance')">
                            Maintenance
                        </BreezeNavLink>
                    </li>
                    <li class="nav-item">
